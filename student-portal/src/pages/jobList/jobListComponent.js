              ...
              {posts.map((post,index) => {
                  return (
                      <div className="posts" key={index}>
                        ...
                        <h1>{post.post}</h1>
                        <Button sx={{width:"200px",height:"50px",alignSelf:"center",marginLeft:"200px",marginTop:"20px",borderRadius:"8px"}} variant="outlined" id={index} onClick={handleClick}>View and Apply</Button>
                        <p>{post.HRName}</p>
